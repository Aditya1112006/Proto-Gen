...
function PrototypeGenerator() {
  ...
  const handleSubmit = async (prompt) => {
    console.log('[PrototypeGenerator] handleSubmit called with:', prompt.substring(0, 50))
    if (!prompt) return
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            {/* Generate Code - Show when in workflow mode AND no code files yet */}
            {currentPrototype?.content && mode === 'workflow' && !currentPrototype?.metadata?.files?.length && (
              <GenerateCodeButton
