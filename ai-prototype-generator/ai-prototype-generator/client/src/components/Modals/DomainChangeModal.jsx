          ...
          <div className="space-y-4">
            ...
            <div className="bg-slate-50 rounded-xl p-4">
              <p className="text-sm text-slate-600 text-center">
                ...
                A new prototype for <strong>&ldquo;{newDomain}&rdquo;</strong> has been generated and is now displayed.
              </p>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex items-start gap-2 text-sm text-slate-500">
                ...
                <p>A new prototype for <strong>"{newDomain}"</strong> is ready</p>
              </div>
              <div className="flex items-start gap-2 text-sm text-slate-500">
                <span className="text-amber-500 mt-0.5">•</span>
                <p>Click <strong>Dismiss</strong> to continue</p>
              </div>
              <div className="flex items-start gap-2 text-sm text-slate-500">
                <span className="text-amber-500 mt-0.5">•</span>
                <p>Click <strong>Start New</strong> to clear and start fresh</p>
              </div>
            </div>
          </div>
        </div>
